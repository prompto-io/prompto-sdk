...
public class UserResponse implements Serializable {
  ...
  public UserResponse errors(List<ValidationError> errors) {
    this.errors = errors;
    return this;
  }

  public UserResponse addErrorsItem(ValidationError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public UserResponse httpCode(Integer httpCode) {
  ...
  **/
  ...
  public UserResponse httpMessage(String httpMessage) {
  ...
  **/
  ...
  public UserResponse user(CustomerUser user) {
    this.user = user;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.errors, userResponse.errors) &&
        Objects.equals(this.httpCode, userResponse.httpCode) &&
        Objects.equals(this.httpMessage, userResponse.httpMessage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errors, httpCode, httpMessage, links, user);
  }
